				...
				<div class="release">
					<div class="release__content">
						...
						<div class="release__stat">
							<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.65,2.24a1,1,0,0,0-.8-.23l-13,2A1,1,0,0,0,7,5V15.35A3.45,3.45,0,0,0,5.5,15,3.5,3.5,0,1,0,9,18.5V10.86L20,9.17v4.18A3.45,3.45,0,0,0,18.5,13,3.5,3.5,0,1,0,22,16.5V3A1,1,0,0,0,21.65,2.24ZM5.5,20A1.5,1.5,0,1,1,7,18.5,1.5,1.5,0,0,1,5.5,20Zm13-2A1.5,1.5,0,1,1,20,16.5,1.5,1.5,0,0,1,18.5,18ZM20,7.14,9,8.83v-3L20,4.17Z"/></svg><?= $countMs['COUNT(music)'].' songs' ?></span>
							<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20,13.18V11A8,8,0,0,0,4,11v2.18A3,3,0,0,0,2,16v2a3,3,0,0,0,3,3H8a1,1,0,0,0,1-1V14a1,1,0,0,0-1-1H6V11a6,6,0,0,1,12,0v2H16a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h3a3,3,0,0,0,3-3V16A3,3,0,0,0,20,13.18ZM7,15v4H5a1,1,0,0,1-1-1V16a1,1,0,0,1,1-1Zm13,3a1,1,0,0,1-1,1H17V15h2a1,1,0,0,1,1,1Z"/></svg><?= $sumView['SUM(view)'].' views' ?></span>
						</div>
					</div>
						...
						<ul class="main__list main__list--playlist main__list--dashbox">
							...
							foreach ($post as $po) {
								...
								<li class="single-item">
									<a data-playlist data-title="<?= $po['name']?>" data-img="<?= 'public/uploads'.$po['avatar']?>" href="<?= 'public/uploads/Music'.$po['music']?>" class="single-item__cover">
										<img src="<?= 'public/uploads'.$po['avatar']?>" alt>
									...
									<div class="single-item__title">
										<h4><a href="#"><?= $po['name']?></a></h4>
										<span><a href="artist.html"></a></span>
									</div>
									<a class="single-item__add" type="button" data-toggle="collapse" data-target="<?= '#collapseExample'.$po['id']?>" aria-expanded="false" aria-controls="collapseExample">
									...
									<a href="<?='public/uploads/Music'.$po['music']?>" download="<?=trim($po['music'],"/")?>" class="single-item__export">
				...
				<div class="article">
					...
					<div class="article__content">
						...
						<?php foreach ($post as $po) {
							# code...
						 ?>
						<div class="collapse mb-3" id="<?= 'collapseExample'.$po['id']?>">
							<div class="card card-body">
								<div class="collapse" id="<?= 'collapseExample'.$po['id']?>">
									<div class="card card-body">
										<b style="color: white">Lời Bài Hát : <?=$po['name']?> </b>
										<p style="color: white" class="ml-3"><?=$po['song_lyric']?></p>
									</div>
								</div>
							</div>
						</div>
					<?php } ?>
					<h4>Thông tin Albums</h4>
						<p><?=$singer['album_information']?></p>
						<i style="color: white"><?=$singer['created_at']?></i>
					</div>
					<!-- end article content -->
						...
						<ul class="comments__list">
							<li class="comments__item">
								<div class="comments__autor">
									<img class="comments__avatar" src="fonts/avatar.svg" alt>
